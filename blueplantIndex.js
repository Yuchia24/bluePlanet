...
function runit(index) {
    ...
    axios.get(' http://ec2-18-180-134-189.ap-northeast-1.compute.amazonaws.com:3000/api/restaurants/dish', { params: { restaurant_id: restaurant_id[index]} })
